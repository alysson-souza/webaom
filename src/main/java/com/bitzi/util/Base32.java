 ...
 * http://www.ietf.org/internet-drafts/draft-josefsson-base-encoding-04.txt or http://josefsson.org/
 * to find a later copy, when the IETF breaks that link)
 *
...
public class Base32 {
    ...
    public static byte[] decode(final String base32) {
        ...
        for (i = 0, index = 0, offset = 0; i < base32.length(); i++) {
            ...
            if (lookup < 0 || lookup >= base32Lookup.length) continue;
