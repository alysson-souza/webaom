 ...
 *
 * <p>MD4 was the precursor to the stronger {@link gnu.crypto.hash.MD5} algorithm, and while not
 * considered cryptograpically secure itself, MD4 is in use in various applications. It is slightly
 * faster than MD5.
 *
 * <p>References:
 *
 * <ol>
 *   <li>The <a href="http://www.ietf.org/rfc/rfc1320.txt">MD4</a> Message-Digest Algorithm.<br>
 *       R. Rivest.
 * </ol>
 *
...
public class MD4 extends BaseHash {
    ...
    /**
     * Public constructor. Initializes the chaining variables, sets the byte count to <code>0</code>
     * , and creates a new block of <code>512</code> bits.
     */
    public MD4() {
