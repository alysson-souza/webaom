...
/**
 * The Tiger message digest. Tiger was designed by Ross Anderson and Eli Biham, with the goal of
 * producing a secure, fast hash function that performs especially well on next-generation 64-bit
 * architectures, but is still efficient on 32- and 16-bit architectures.
 *
 * <p>Tiger processes data in 512-bit blocks and produces a 192-bit digest.
 *
 * <p>References:
 *
 * <ol>
 *   <li><a href="http://www.cs.technion.ac.il/~biham/Reports/Tiger/">Tiger: A Fast New Hash
 *       Function</a>, Ross Anderson and Eli Biham.</a>
 * </ol>
 *
