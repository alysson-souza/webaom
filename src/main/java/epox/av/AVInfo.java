...
public class AVInfo {
    ...
    public GenericTrack getGeneric(int n) throws IOException {
        ...
        gt.num = n;
        if (trackGetGeneric(address, n, gt)) return gt;
        return null;
    }
    ...
    public VideoTrack getVideo(GenericTrack gt) throws IOException {
        ...
        if (trackGetVideo(address, gt.num, vt)) return vt;
        return null;
    }
    ...
    public AudioTrack getAudio(GenericTrack gt) throws IOException {
        ...
        if (trackGetAudio(address, gt.num, at)) return at;
        return null;
    }
