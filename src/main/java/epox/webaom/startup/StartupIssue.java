...
/**
 * Represents an issue encountered during application startup.
 * Includes severity level and user-friendly messaging.
 */
public class StartupIssue {
	 ...
	 */
	public StartupIssue(Severity severity, String title, String message, String suggestion, Exception cause) {
