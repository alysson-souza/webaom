    ...
    private class EmuWorker extends Thread {
        ...
        public String updateStorageOrState(String parameters, int usageType) throws AniDBException {
            ...
            try {
                ...
                } else if (arguments[2].length() > 5
                        && arguments[2].toLowerCase().startsWith("upto ")) {
        ...
        public String formatMyStats(String response) {
            ...
            String contributionText =
                    fields[4] + " animes, " + fields[5] + " eps, " + fields[6] + " files, " + fields[7] + " groups";
            ...
            String viewedTime =
                    fields.length > 16 ? " Viewed: " + formatMinutes(StringUtilities.i(fields[16])) + "." : "";
